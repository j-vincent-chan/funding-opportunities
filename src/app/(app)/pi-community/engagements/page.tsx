...
export default async function CommunityEngagementsPage() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="app-page-title">Strategist engagements</h1>
        <p className="app-page-description">
          Operational tracking (source of truth for outreach). Link investigators to funding
          opportunities where relevant. Proposal links are optional UUIDs until a proposals module
          exists.
        </p>
      </header>
                  ...
                  {(engagements ?? []).map((e) => {
                    ...
                    return (
                      <tr key={e.id} className="border-b border-slate-100">
                        ...
                        <td className="py-2">
                          <Link
                            href={`/pi-community/engagements/${e.id}`}
